module V1
  class LinksController < V1::BaseController
    ...
    def index
      pagy, links = pagy(Link.all, **pagy_params)
      ...
      json_response({ pagy: { page: pagy.page, per_page: pagy.items, total: pagy.count, next_page: pagy.next, total_pages: pagy.pages }, data: links })
    rescue
      json_response({})
    end
